...
public class IOAnalysisImpl implements IOAnalysis{
     ...
     * 
     * Il metodo serializza un oggetto 'Analysis' e lo salva su un file specificato.
     * In caso di errore durante il salvataggio verrà stampato lo stack trace
     * relativo all'eccezione che viene sollevata
     * 
     ...
     * 
     * Questo metodo deserializza un oggetto di tipo Analysis da un file specificato
     * Nel caso in cui il file non esista o non contenga un oggetto valido verrà
     * sollevata un eccezzione e verrà stampato lo stack trace relativo all'eccezione
     * sollevata
     * 
