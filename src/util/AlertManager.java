...
/**
 * @class AlertManager
 * @brief Classe che gestisce gli alert in modo centralizzato all'interno
...
public class AlertManager {
     ...
     * 
     * Il metodo crea un alert con il tipo e il titolo specificato. 
     * Nel caso in cui l'alert sia di tipo 'CONFIRMATION', l'utente dovrà rispondere
     * tramite un pulsante ('ok' o 'confirm'); tutti gli altri tipi di alert vengono
     ...
     * @return La risposta dell'utente sotto forma di ButtonType,
     * se il tipo 'CONFIRMATION'
     * 
     * Restituisce {@link ButtonType#CANCEL} se l'utente non seleziona nulla.
     * Se il tipo non è "CONFIRMATION", non restituisce nulla.
     * 
     * @pre {@code type} deve essere un valore valido riconosciuto
     * dalla classe {@link Alert.AlertType}.
