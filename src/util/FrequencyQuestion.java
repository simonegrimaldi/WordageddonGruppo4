...
public class FrequencyQuestion extends Question<Integer> {
     ...
     * nel documento. La risposta corretta è la frequenza di quella parola nel
     * testo. Inoltre, vengono generate 3 opzioni errate ma plausibili.
     *
     * @param analysis L'analisi del documento da cui verrà estratta la parola e
     * la frequenza.
     */
    ...
    private List<Integer> generateOptions(int correctAnswer) {
        ...
        while (options.size() < 4) {
            int wrongAnswer = correctAnswer + rand.nextInt(11) - 5;
     ...
     * @return Il punteggio dell'utente (10 per risposta corretta, -3 per
     * risposta errata, 0 se la risposta è nulla).
